...
export default function CRSignupPage() {
          ...
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              <CardTitle className="text-3xl font-bold text-gray-900">
                Community Representative Sign Up
              </CardTitle>
              <CardDescription className="text-gray-600 mt-2">
                Join us as a community representative
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
              ...
              <div className="border-t pt-4 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Describe your experience in community service, delivery management, etc."
